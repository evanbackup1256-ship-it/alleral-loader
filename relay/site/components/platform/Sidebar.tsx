    ...
    <>
      ...
      <div className="border-t border-border p-3">
        ...
        <div className={clsx("flex items-center gap-2 rounded-xl border border-border bg-black/25 px-3 py-2.5", collapsed && "justify-center px-2")}>
          {!collapsed ? <StatusPill kind={relayKind} size="sm" /> : <span className={clsx("h-2 w-2 rounded-full", online !== false ? "bg-green-400 shadow-[0_0_10px_rgba(52,211,153,0.7)]" : "bg-red-400")} />}
        </div>
      </div>
    </>
  );
